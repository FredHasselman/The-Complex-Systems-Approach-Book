...
* Tutorial on **Effect Size Confidence Intervals** and more:
     + In this tutorial on [estimating Effect Size Confidence Intervals (ESCI)](http://fredhasselman.com/Onderwijs/OSCblog.html) there are a lot of examples on how to use `R`. 
