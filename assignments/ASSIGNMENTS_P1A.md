...
Equation \@ref(eq:linmap) is the ordinary difference equation (ODE) discussed in [the course book](https://darwin.pwo.ru.nl/skunkworks/courseware/1718_DCS/introduction-to-the-mathematics-of-change.html) and is called the *Linear Map*:
...
For the Linear Map you could use this template ([also see the notes in the course book](https://darwin.pwo.ru.nl/skunkworks/courseware/1718_DCS/implementing-iterative-functions.html)):
...
In the [course book](https://darwin.pwo.ru.nl/skunkworks/courseware/1718_DCS/advmodels.html
