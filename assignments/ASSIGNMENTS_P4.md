...
## 1 0.4399209      0 1.0000000 1.0143326 0.1484117
## 2 0.0500000      1 0.5600791 0.6010298 0.1141328
## 
## Variable importance
##   x 
## 100 
...
![](ASSIGNMENTS_P4_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
...
![](ASSIGNMENTS_P4_files/figure-html/unnamed-chunk-11-1.png)<!-- -->
e) 
...
![](ASSIGNMENTS_P4_files/figure-html/unnamed-chunk-15-1.png)<!-- -->
...
\BeginKnitrBlock{rmdnote}<div class="rmdnote">The following set of assignments serve as a demonstration to get you acquianted with graph models, just follow the instructions.</div>\EndKnitrBlock{rmdnote}
